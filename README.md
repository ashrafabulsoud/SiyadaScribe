> [!WARNING]
> SiyadaScribe is an experimental project. Please read the **[Usage Warning](#usage-warning-️)** section carefully before proceeding.

<p align="center">
  <img src="/assets/siyadascribe_icon.png" width="150" alt="SiyadaScribe Logo">
</p>

<div align="center">

[![CI](https://github.com/ashrafabulsoud/SiyadaScribe/actions/workflows/ci.yml/badge.svg)](https://github.com/ashrafabulsoud/SiyadaScribe/actions/workflows/ci.yml)
[![Coverage Status](https://coveralls.io/repos/github/ashrafabulsoud/SiyadaScribe/badge.svg?branch=main)](https://coveralls.io/github/ashrafabulsoud/SiyadaScribe?branch=main)
[![CodeQL](https://github.com/ashrafabulsoud/SiyadaScribe/actions/workflows/github-code-scanning/codeql/badge.svg)](https://github.com/ashrafabulsoud/SiyadaScribe/actions/workflows/github-code-scanning/codeql)
[![Code style: ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Docs](https://img.shields.io/badge/docs-SiyadaScribe-blue)](https://github.com/ashrafabulsoud/SiyadaScribe/tree/main/docs)

</div>

SiyadaScribe is a free, open-source, AI scribe with a built-in patient management system and agentic AI capabilities. It's designed as a local-first alternative to SaaS medical scribes that you can run on your own hardware.

SiyadaScribe is a rebranded distribution of an upstream MIT-licensed open-source project. The
...
<p align="center">
  <img src="/assets/readme_screenshot.png" width="600" alt="SiyadaScribe Screenshot">
</p>
...
Pre-built Apple Silicon (macOS) binaries and Flatpaks (Linux - Vulkan) are available from [GitHub Releases](https://github.com/ashrafabulsoud/SiyadaScribe/releases).
...
Pre-built images are available from [GitHub Container Registry](https://github.com/ashrafabulsoud/SiyadaScribe/pkgs/container/siyadascribe):

```bash
docker pull ghcr.io/ashrafabulsoud/siyadascribe:latest
```
...
services:
  siyadascribe:
    image: ghcr.io/ashrafabulsoud/siyadascribe:latest
    container_name: siyadascribe
    ports:
      - "5000:5000"
    environment:
      ...
      #   IPs/CIDRs of EVERY proxy hop between SiyadaScribe and clients.
...
Then `docker compose up -d`. See the [Setup guide](https://github.com/ashrafabulsoud/SiyadaScribe/tree/main/docs/setup.md) for full instructions including `.env` configuration.
...
SiyadaScribe is an experimental project intended for educational and personal use only. **It is not a certified medical device, should NOT be used for clinical decision-making, and is not suitable for production deployment as provided in this repo.** If you intend to use it in a clinical setting, you are responsible for ensuring compliance with local applicable regulations (HIPAA, GDPR, TGA, etc.)
...
Third-party models, runtimes, and libraries are listed in [Technical Stack](#technical-stack).
Project documentation: [SiyadaScribe docs](https://github.com/ashrafabulsoud/SiyadaScribe/tree/main/docs/README.md).
