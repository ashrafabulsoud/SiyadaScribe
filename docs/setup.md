...
1.  **Clone the Repository:**
    ```bash
    git clone https://github.com/ashrafabulsoud/SiyadaScribe.git
    cd SiyadaScribe
    ```
...
If you encounter problems, please create an issue on the [GitHub repository](https://github.com/ashrafabulsoud/SiyadaScribe/issues).
